...
###############################################################################
print("Copyright (C) 2025  Author Dr Antony Blundell "
      "This program comes with ABSOLUTELY NO WARRANTY; "
      "for details see the included licence. This is "
      "free software, and you are welcome to redistribute it "
      "under certain conditions; for details see the included licence.")
print("")
print("")
user_agreement = input("Press Enter to accept and continue")
...
# location_1  = "G:\\PPSP" 
# file_name_option = "KM_ALL_DEPTH_PARA.csv"
...
def option_sort():   
    ...
    try:
        ...
        print(f"Problem loading {file_name_option} file."
